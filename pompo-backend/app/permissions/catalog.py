...
PERMISSIONS: tuple[PermissionDefinition, ...] = (
    ...
    PermissionDefinition("qr:read", "View merchant QR codes."),
    PermissionDefinition("qr:create", "Create static and dynamic QR codes."),
    PermissionDefinition("qr:revoke", "Revoke merchant QR codes."),
    PermissionDefinition("settlements:read", "View settlement batches and records."),
    PermissionDefinition("settlements:create", "Ingest provider settlement files."),
    PermissionDefinition("reconciliation:read", "View reconciliation records and runs."),
    PermissionDefinition("reconciliation:update", "Record reconciliation resolution."),
